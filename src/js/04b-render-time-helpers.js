/* ── Render — timeline time-editor helpers (split out of 04-render.js) ──
   Small pure/DOM-utility functions used by render()'s inline time-editor
   panel and entry-row duration display. */
