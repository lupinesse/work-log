/* ── Today's Flow — header (split out of 11-timeflow.js) ──
   Day-overview strip, gap reminder, and the section header (totals +
   segmented control). Time-formatting helpers (stripPct, tsToMins, fmtHm,
   activeTimerDurationMs) live here since the day-strip is their primary
   consumer; renderFlowView (11d-timeflow-flowview.js) also calls fmtHm and
