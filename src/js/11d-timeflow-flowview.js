/* ── Today's Flow — Flow view (split out of 11-timeflow.js) ──
   The vertical duration-weighted timeline list, its session-note/task-note
   widgets, and the note-editing state that only these touch. Uses
   fmtHm/activeTimerDurationMs from 11c-timeflow-header.js. */
