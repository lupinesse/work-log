...
| Integration / CI-script tests | ✅ Pass | `npm run test:scripts` runs all `.github/scripts/test/*.test.mjs` files — **393 tests across 82 suites**, 0 failures (up from 324/68 as of 2026-09-01) |
| Total test count | ✅ Pass | **1,550 tests** (847 unit + 310 smoke + 393 CI-scripts); up from 1,342 as of 2026-09-01 |
