...
Work Log is a single-page ADHD-friendly time tracking application built as one HTML file. It uses modular JavaScript (58 source files across 30+ numbered modules) and organised SCSS, bundled via build.js.
